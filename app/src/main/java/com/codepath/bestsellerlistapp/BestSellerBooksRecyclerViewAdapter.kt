...
class BestSellerBooksRecyclerViewAdapter(
    ...
    inner class BookViewHolder(val mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        val mBookDes: TextView = mView.findViewById<View>(id.book_description) as TextView
    ...
    override fun onBindViewHolder(holder: BookViewHolder, position: Int) {
        ...
        holder.mBookDes.text = book.description
        Glide.with(holder.mView).load(book.bookImageUrl).centerInside().into(holder.mBookImg)
